# AI Quant Trading System v3

Generated from the v2.5.4 Longbridge baseline under the unified v3 engineering architecture.
...
## Local smoke tests
python tests/smoke_test.py premarket
python tests/smoke_test.py market
python tests/smoke_test.py postmarket
python tests/smoke_test.py backtest
